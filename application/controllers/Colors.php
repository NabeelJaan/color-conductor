...
class Colors extends CI_Controller {
	...
	function get_color_post(){
		...
		if($this->input->post('color_jumbo')){

	     $data['jumbo']=$this->input->post('color_jumbo');
	...
	function get_colors(){
		...
		$joinColumsName =array("id,color_img,color_title,coarse,line no : 1143,fine,jumbo,hex_code,created_date,updated_date,status");

        $aColumns       = array("id","color_title","hex_code","color_img","coarse","fine","jumbo","status");

        $findColumns    = array('id','color_title','hex_code','coarse','fine','jumbo','status');
