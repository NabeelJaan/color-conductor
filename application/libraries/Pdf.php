...
require_once(APPPATH."third_party/PdfImage/InvalidFormat.php");
require_once(APPPATH."third_party/PdfImage/PdfDoesNotExist.php");
require_once(APPPATH."third_party/PdfImage/PageDoesNotExist.php");
require_once(APPPATH."third_party/PdfImage/InvalidLayerMethod.php");
