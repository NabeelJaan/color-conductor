...
//print_r($get_color);
				...
				<!---- add jumbo---------------------->			
							...
							<li id="jumbo<?php echo $get_color['id']; ?>_<?php echo $i; ?>" data-colid="<?php echo $get_color['id']; ?>" data-count="<?php echo $i; ?>" class="jumbo_1 jumbo_1_<?php echo $get_color['id']; ?>_<?php echo $i; ?> active">
								...
								<span class="jumbo" data-id="<?php echo $get_color['id']; ?>" data-coarse="<?php echo $get_color['coarse']; ?>" data-fine="<?php echo $get_color['fine']; ?>"  data-jumbo="<?php echo $get_color['jumbo']; ?>">Jumbo</span>
