					...
					<li id="delete_part<?php echo $array['id']; ?>_<?php echo $i; ?>" data-count_var="<?php echo $i; ?>" class="<?php //echo $cork_class; ?>">
					  ...
					  <div class="content">
						...
						<!-- **************** add  Jumbo**************** -->		
									...
									<span class="jumbo" id="<?php echo $get_color['id']; ?>" data-id="<?php echo $get_color['id']; ?>" data-jumbo="<?php echo $get_color['jumbo']; ?>" data-coarse="<?php echo $get_color['coarse']; ?>" data-fine="<?php echo $get_color['fine']; ?>" >Jumbo</span>
					...
					<!-- **************** End Jumbo**************** -->
						...
						<?php 
							if($get_color['fine']=='1' && $get_color['coarse']=='0' && $get_color['jumbo']=='0'){
								...
								/*if($mixValue >= 30){
					  				echo $stylePoointer="pointer-events: none";
					  			}else{
					  				$stylePoointer="";
					  			}*/
					  ...
					  <div class="color_slider slider_range <?php echo ($array['fine']==1)?"fine":"coarse"; ?>" data-id='<?php echo $array['id']; ?>' aria-disabled="false" style="width: 100%;" id="slide<?php echo $i.$array['id']; ?>" data-hexcode="<?php echo $get_color['hex_code']; ?>" data-count="<?php echo $i; ?>"  field='slider_range_text<?php echo $get_color['id'].'_'.$i; ?>'   >
