					  ...
					  <div class="content">
						...
						<div  class="name"> <?php echo $get_color['color_title']; ?> </div>
						 ...
						 <ul class="coarse_fine">
								...
								//echo $array['jumbo'];
								if($array['coarse'] == 0 && $array['fine'] == 0 && $get_color['jumbo']==1 || $array['jumbo']>0){
									$active="active";
								...
								if($array['coarse'] == 0 && $array['fine'] == 1 && $get_color['jumbo']==0 ){
									$active1="active";										
								}else{
									$active1='';
								}
						...
						<!-- **************** add  Jumbo**************** -->		
									...
									<span class="jumbo" id="<?php echo $get_color['id']; ?>" data-id="jumbo_<?php echo $get_color['id']; ?>" data-jumbo="<?php echo $get_color['jumbo']; ?>" data-coarse="<?php echo $get_color['coarse']; ?>" data-fine="<?php echo $get_color['fine']; ?>" >Jumbo</span>
					...
					<!-- **************** End Jumbo**************** -->
						...
						<?php 
							if($get_color['fine']=='1' && $get_color['coarse']=='0' && $get_color['jumbo']=='0'){
								$mixValue='15';
							}if($get_color['fine']=='0' && $get_color['coarse']=='1' && $get_color['jumbo']=='0'){
								$mixValue='15';
						...
						<div class="slider_dropdown">
							...
							<!-- <input type='button' value='-' class='qtyminus' field='slider_value_text<?php echo $get_color['id']; ?>' id="" /> -->
							...
							<input type='button' value='+' class='qtyplus' field='slider_value_text<?php echo $get_color['id'].'_'.$i; ?>' id="qtyplusId_<?php echo $get_color['id'];?>"/>
