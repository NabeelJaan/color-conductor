				...
				<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
					  ...
					  <div class="content">
						...
						<div  class="name"> <?php echo $get_color['color_title']; ?> </div>
						 ...
						 <ul class="coarse_fine">
								...
								<!-- **************** add Jubo and  Chunk**************** -->		
									<?php if($get_color['coarse'] == 0 && $get_color['fine']==0 && $get_color['color_title']!='Black'){ ?>
					...
					<!-- **************** End Chunk**************** -->
						...
						<?php 
							...
							/*** Minimum 20% fines if used with jumbo/chunks */
							else if( $get_color['fine']=='1' && $get_color['coarse']==1 && ( $get_color['chunk']=='1' || $get_color['jumbo']=='1' )){
								$mixValue='0';
								$valueJubmoChunk='100';
								$classJubmo="classFineCourse";
							...
							}/*** Have to add course/fine = adds up to 100% with jumbo/chunks */
							else if($get_color['fine']=='1' && $get_color['coarse']=='1' && $get_color['jumbo']=='1' && $get_color['chunk']=='1' ){
								$mixValue='0';
								$valueJubmoChunk='100';
							...
							else if($get_color['chunk']=='1' && $get_color['fine']=='0' && $get_color['coarse']=='0' && $get_color['jumbo']=='0'){
								$mixValue='0';
								$valueJubmoChunk='30';
								$classJubmo="classJubmo";
								$classJubmoChunk="classJubmoChunk";
							...
							else if($get_color['jumbo']=='1' && $get_color['fine']=='0' && $get_color['coarse']=='0' && $get_color['chunk']=='0'){
								$mixValue='0';
								$valueJubmoChunk='30';
								$classJubmo="classJubmo";
								$classJubmoChunk="classJubmoChunk";
							...
							/*** Chunks AND Jumbo = max 40% */
							else if($get_color['chunk']=='1' && $get_color['jumbo']=='1' && $get_color['fine']=='0' && $get_color['coarse']=='0'){
								$mixValue='0';
								$valueJubmoChunk='40';
								$classJubmo="classJubmo";
								$classJubmoChunk="classJubmoChunk";
							...
							else if($get_color['coarse'] == 0 && $get_color['fine']==0 && $get_color['chunk']=='1' && $get_color['jumbo']=='1'){ 
					  ...
					  <div class="color_slider slider_range <?php echo $slider_rangeValue; ?>  <?php //echo ($array['fine']==1)?"fine":"coarse"; ?>" data-id='<?php echo $array['id']; ?>' aria-disabled="false" style="width: 100%;" id="slide<?php echo $i.$array['id']; ?>" data-hexcode="<?php echo $get_color['hex_code']; ?>" data-count="<?php echo $i; ?>"  field='slider_range_text<?php echo $get_color['id'].'_'.$i; ?>'   >
						  ...
						  <input type="hidden" data-id='<?php echo $get_color['id']; ?>' name="slider_value<?php echo $get_color['id'].'_'.$i; ?>" class="slider_valueP<?php echo $get_color['id']; ?> <?php echo $classJubmo.$get_color['id']; ?>" id="slider_value<?php echo $get_color['id'].'_'.$i; ?>" value="<?php //echo $array['value']; ?><?php echo $mixValue; ?>" />
						  	...
						  	<input type="hidden" name="fixed_min_value_Chunk_Jumbo<?php echo $get_color['id'];?>" id="fixed_min_value_Chunk_Jumbo<?php echo $get_color['id'];?>" value="<?php echo $valueJubmoChunk; ?>" />
