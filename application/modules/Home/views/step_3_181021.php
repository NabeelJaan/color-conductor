					...
					<li id="delete_part<?php echo $array['id']; ?>_<?php echo $i; ?>" data-count_var="<?php echo $i; ?>" class="<?php //echo $cork_class; ?>">
					  ...
					  <div class="content">
						...
						<!-- **************** add  Jumbo**************** -->		
									...
									<li id="jumbo<?php echo $get_color['id']; ?>_<?php echo $i; ?>" data-colid="<?php echo $get_color['id']; ?>" data-count="<?php echo $i; ?>" class="jumbo_1 jumbo_1_<?php echo $get_color['id']; ?>_<?php echo $i; ?> <?php //echo  ($array['jumbo']==1)?"active":""; ?>">

									<span class="jumbo" data-id="<?php echo $get_color['id']; ?>" data-jumbo="<?php echo $get_color['jumbo']; ?>" data-coarse="<?php echo $get_color['coarse']; ?>" data-fine="<?php echo $get_color['fine']; ?>" >Jumbo</span>
					...
					<!-- **************** End Jumbo**************** -->
						...
						<?php 
							if($get_color['fine']=='1' && $get_color['coarse']=='0' && $get_color['jumbo']=='0'){
								$mixValue='15';
							}else if($get_color['fine']=='1' && $get_color['coarse']=='1' && $get_color['jumbo']=='1'){
								$mixValue='30';
							}else{
						...
						<div class="slider_dropdown">
							...
							<input type='button' value='-' class='qtyminus' field='slider_value_text<?php echo $get_color['id'].'_'.$i; ?>' />

							<!-- <input type='button' value='-' class='qtyminus' field='slider_value_text_2' /> -->
							...
							<input type='button' value='+' class='qtyplus' field='slider_value_text<?php echo $get_color['id'].'_'.$i; ?>' />
					 ...
					 <!--  <input type="hidden" name="fixed_min_value_fine" id="fixed_min_value_fine" value="<?php  echo $mixValue;  ?>" /> -->
					  ...
					  <div class="color_slider slider_range <?php echo ($array['fine']==1)?"fine":"coarse"; ?>" data-id='<?php echo $array['id']; ?>' aria-disabled="false" style="width: 100%;" id="slide<?php echo $i.$array['id']; ?>" data-hexcode="<?php echo $get_color['hex_code']; ?>" data-count="<?php echo $i; ?>"  >
						  ...
						  <input type="hidden" data-id='<?php echo $get_color['id']; ?>' name="slider_value<?php echo $get_color['id'].'_'.$i; ?>" class="slider_valueP<?php echo $get_color['id']; ?>" id="slider_value<?php echo $get_color['id'].'_'.$i; ?>" value="<?php //echo $array['value']; ?><?php echo $mixValue; ?>" />
