	...
	$.ajax({
		...
		complete:function(res){
			...
			else
			{
				...
				if(html_content.coarse == 1 && html_content.fine == 1 && html_content.jumbo == 0 && html_content.color_title != 'Black'){					
					type = 'Coarse';
					type_class="coarse";
		...
		/****************Jumbo****************/
 				else if(html_content.jumbo == 1 && html_content.color_title != 'Black'){
...
$(document).on('click',".jumbo",function(){
