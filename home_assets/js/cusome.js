...
$( ".slider_rangeJumbo" ).slider({
	...
	slide: function( event, ui ) {		
		...
		if(id!=''){		
			//var valueName ='fixed_min_value_Chunk_Jumbo'+id;
			//alert(valueName);
		   //min_val2 = $('#slider_valueJumboChunk'+id+'_'+count).val(); 	
		   min_val = $('input[name=fixed_min_value_Chunk_Jumbo'+id+']').val(); 	
	...
	slide: function( event, ui ) {
		...
		if(id != '' ){
		   ...
		   // min_val = $('input[name=fixed_min_value_black]').val();
		    //min_val2 = $('#slider_value'+id+'_'+count).val();
		    //min_val2 = 15;
		     min_val2 = $('input[name=slider_value'+id+'_'+count+']').val();
		  	//alert(min_val2);
		    if(min_val2 > ui.value){
		       return false; 
		    } 
		    else{
		    return checkTotal(this, ui.value, id);
...
$(".pick_color").on('click',function(){
	...
	$.ajax({
		...
		complete:function(res){
			...
			else if($(".selected_granulas"+html_content.id).length>=2 && html_content.coarse == 1 && html_content.fine == 0) {
				swal("","You already have the maximum amount of this color!!", "error");
			}
			...
			else if($(".selected_granulas"+html_content.id).length>=2 && (html_content.coarse == 0 && html_content.fine == 0) && (html_content.chunk == 1 && html_content.jumbo == 1)){
				swal("","You already have the maximum amount of this color!!", "error");
			}		
			
			else if(html_content.coarse == 0 && html_content.fine==0 && html_content.chunk == 0 && html_content.jumbo == 0) {
			...
			else
			{
				...
				if(html_content.coarse == 1 && html_content.fine == 1 && html_content.chunk == 1 && html_content.jumbo == 0 && html_content.color_title != 'Black'){					
					type = 'Coarse';
					type_class="coarse";
					var fine_coarse_html = '<ul class="coarse_fine"><li id="fine'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="fine_1 fine_1_'+html_content.id+'_'+color_count+' active"><span class="fine" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'">Fine</span></li><li id="coarse'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="coarse_1 coarse_1_'+html_content.id+'_'+color_count+'"><span class="coarse" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'">Coarse</span></li><li id="chunk'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="chunk_1 chunk_1_'+html_content.id+'_'+color_count+'"><span class="chunk" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-chunk="'+html_content.chunk+'">Chunk</span></li></ul>';
				}
		...
		/****************Jumbo****************/
 				else if(html_content.jumbo == 1 && html_content.chunk == 1  && html_content.fine == 1 && html_content.coarse == 1 && html_content.color_title != 'Black'){
					//alert('03333333222222');
						type = 'jumbo'
						type_class="jumbo";
					var fine_coarse_html = '<ul class="coarse_fine"><li id="fine'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="fine_1 fine_1_'+html_content.id+'_'+color_count+' active"><span class="fine" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-jumbo="'+html_content.jumbo+'">Fine</span></li><li id="coarse'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="coarse_1 coarse_1_'+html_content.id+'_'+color_count+'"><span class="coarse" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-jumbo="'+html_content.jumbo+'">Coarse</span></li><li id="jumbo'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="coarse_1 coarse_1_'+html_content.id+'_'+color_count+'"><span class="jumbo" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-jumbo="'+html_content.jumbo+'">Jumbo</span></li><li id="chunk'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="chunk_1 chunk_1_'+html_content.id+'_'+color_count+'"><span class="chunk" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-chunk="'+html_content.chunk+'">Chunk</span></li></ul>';
				}
				/**************** Jumbo and Chunk ****************/
				else if(html_content.chunk == 1 && html_content.Jumbo == 1  && html_content.fine == 0  && html_content.coarse == 0 ){
						type = 'jumbo'
						type_class="jumbo";
					var fine_coarse_html = '<ul class="coarse_fine"><li id="jumbo'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="coarse_1 coarse_1_'+html_content.id+'_'+color_count+'"><span class="jumbo" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-jumbo="'+html_content.jumbo+'">Jumbo</span></li><li id="chunk'+html_content.id+'_'+color_count+'" data-colid="'+html_content.id+'" data-count="'+color_count+'" class="chunk_1 chunk_1_'+html_content.id+'_'+color_count+'"><span class="chunk" data-id="'+html_content.id+'" data-coarse="'+html_content.coarse+'" data-fine="'+html_content.fine+'" data-chunk="'+html_content.chunk+'">Chunk</span></li></ul>';
				}
				/*else if(html_content.coarse == 0 && html_content.fine == 1 && html_content.color_title != 'Black'){
					type = 'Fine';
					type_class="fine";
...
$(".go_to_step3").on("click",function(){
	...
	else
	{
		...
		var check_multiple_array_jumbo=[];
		...
		var sorted_fine_array = check_multiple_array_fine.sort();
			  ...
			  /*var sorted_jumbo_array = check_multiple_array_jumbo.sort();
			  for (var i = 0; i < check_multiple_array_jumbo.length; i++)
			  {
				 if (sorted_jumbo_array[i + 1] === sorted_jumbo_array[i])
				 {
					
					 swal("",'You can only select one instance of fine or coarse or Jumbo grain for a single color!!', "error");
					 return;
				 }
				  if($.inArray(sorted_jumbo_array[i], sorted_fine_array) !== -1)
				  {
				  	 swal("",'You can\'t select jumbo and fine for same color!!', "error");
					 return;
				  }
			  }*/
...
$(".no_swatch_created").on('click',function(){
	...
	$(".mix_it").on('click',function(){
		...
		var jumbo_id_size_array = [];
		var chunk_id_size_array = [];
		...
		$(".slider_range").each(function () {
		 ...
		 if($(".fine_1_"+colors_id+"_"+counter).hasClass('active')){
		  ...
		  else if($(".jumbo_1_"+colors_id+"_"+counter).hasClass('active')){
			jumbo_size = parseInt(jumbo_size) +parseInt(amount);
			 jumbo_id_size_array.push([colors_id,parseInt(amount)]);
			   size = "jumbo";
		  }
		  else if($(".chunk_1_"+colors_id+"_"+counter).hasClass('active')){
			chunk_size = parseInt(chunk_size) +parseInt(amount);
			 chunk_id_size_array.push([colors_id,parseInt(amount)]);
			   size = "chunk";
		  }
		...
		$.each(formula, function () {
			...
			if ((this.coarse_fine) === "jumbo")
			{
				check_multiple_array_jumbo.push(this.name);
			}
			if ((this.coarse_fine) === "chunk")
			{
				check_multiple_array_chunk.push(this.name);
			}		
		});
		 var sorted_fine_array = check_multiple_array_fine.sort();
		  for (var i = 0; i < check_multiple_array_fine.length; i++)
		...
		{
			if(image_info[i]['flecks_size']==undefined){
				jumboSIze="";
			}else{
				jumboSIze=image_info[i]['flecks_size'];
			}
		 var file_Chunks = image_info[i]['id']+'_'+image_info[i]['percent'] + '_' + image_info[i]['r'] + '_' + image_info[i]['g'] + '_' + image_info[i]['b'] + '_' + jumboSIze + '-';
	...
	$(document).on('click','.qtyplus',function(e){
	 ...
	 $(document).on('click',".qtyminus",function(e) {
        ...
        min = $('#fixed_min_value_black').val();
			...
			var count = $(this).attr("data-count");
			 ...
			 var fieldName = $(this).attr('field');
				...
				if(fieldName == "slider_value_text"+id+"_"+count){		
			   var min = $('.classFineCourse'+id).val();       
			      if(min >= currentVal){
			          return false;
			      }
			  }
        ...
        /*if(fieldName == 'slider_value_text_2'){
        min = $('#fixed_min_value_fine').val();
...
$(document).on('click',".coarse_1",function(){
	...
	$('#jumbo'+id+'_'+$(this).data('count')).removeClass('active');
	$('#chunk'+id+'_'+$(this).data('count')).removeClass('active');
	$(this).addClass('active');
...
$(document).on('click',".jumbo_1",function(){
	//alert('dsfsdf');
	var id=$(this).data('colid');
	$('#jumbo'+id+'_'+$(this).data('count')).removeClass('active');
	$('#fine'+id+'_'+$(this).data('count')).removeClass('active');
...
$(document).on('click',".chunk_1",function(){
	//alert('dsfsdf');
	var id=$(this).data('colid');
	$('#chunk'+id+'_'+$(this).data('count')).removeClass('active');
	$('#jumbo'+id+'_'+$(this).data('count')).removeClass('active');
...
$(document).on('click',".qtyplusJubmo",function(e) {
        // Stop acting like a button
        e.preventDefault();
        // Get the field name
        fieldName = $(this).attr('field');
        ...
        var currentVal = parseInt($('input[name='+fieldName+']').val());
			 ...
			 var fieldName = $(this).attr('field');
			  ...
			  //alert(currentVal);
				if(fieldName == "slider_value_text"+id+"_"+count){		
			   //var min = $('.classJubmoChunk'+id).val();       
			   var min = 30;       
			      if(min > currentVal){			      
			          return false;
			      }
		 ...
		 var tot_progress =$(".classJubmo'+id").val();
...
$(".jumbo").click(function(){
 ...
 var id = $(this).attr("id");	
//alert(id);
       $('.slider_valueP'+id).val('40');
       $('.slider_range'+id).addClass('slider_rangeJumbo');
       $('.slider_valueJumboChunk'+id).val('40');
       	$('.slider_range').removeClass('slider_rangeWihoutJumboCoursa');
       	$('.qtyplus').addClass('qtyplusJubmo');

       	$('#fixed_min_value_Chunk_Jumbo'+id).val('40');
	...
	$(".chunk").click(function(){
 			...
 			$('.slider_range'+id).addClass('slider_rangeJumbo');
 			//$('.slider_range').removeClass('slider_rangeJumbo');
       $('.slider_valueP'+id).val('30');
       $('.slider_valueJumboChunk'+id).val('30');
       	$('.slider_range').removeClass('slider_rangeWihoutJumboCoursa');
       	$('.slider_range').removeClass('slider_rangeJumbo');
       	$('.qtyplus').addClass('qtyplusJubmo');

       	$('.slider_range').addClass('slider_rangeCunk');
        
        

});

//$(document).on('click',".coarse",function(){
	$(".coarse").click(function(){	

 var id = $(this).attr("data-id");	

      // $('.slider_range').addClass('slider_rangeWihoutJumboCoursa');
       $('.slider_range').removeClass('slider_rangeJumbo');
       $('.qtyplus').removeClass('qtyplusJubmo');
       $('.slider_valueP'+id).val('100');
       $('.slider_valueJumboChunk'+id).val('100');

        $('#fixed_min_value_Chunk_Jumbo'+id).val('100');
        

});
//$(document).on('fine',".coarse",function(){
	$(".fine").click(function(){
	
 			var id = $(this).attr("data-id");	
 			var Cid = $(this).attr("data-colid");	
 			//$('.slider_range').addClass('slider_rangeWihoutJumboCoursa');
 			$('.qtyplus').removeClass('qtyplusJubmo');
      $('.slider_valueP'+id).val('100');
      $('.slider_valueJumboChunk'+id).val('100');
     ...
     // $('.classJubmoChunk'+id).removeClass('slider_valueJumboChunk'+id);
      //$('.classJubmoChunk'+id).removeClass('slider_valueJumboChunk'+id);
